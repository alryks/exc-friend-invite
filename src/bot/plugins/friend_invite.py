...
class FriendInvitePlugin(Plugin):
    ...
    def _dialog_elements(self, session: FlowSession, data: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        elements = [
            ...
            {"display_name": "Рекомендатель", "name": "referral", "type": "text", "default": data.get("referral", "")},
            {"display_name": "ФИО кандидата", "name": "name", "type": "text", "default": data.get("name", "")},
            {
                "display_name": "Пол",
                "name": "gender",
                "type": "radio",
            ...
            {"display_name": "Телефон", "name": "phone", "type": "text", "subtype": "tel", "default": data.get("phone", "")},
            {"display_name": "Дата рождения", "name": "age", "type": "date", "default": str(data.get("age", ""))[:10]},
            {"display_name": "Дата прибытия", "name": "date_on_object", "type": "date", "default": str(data.get("date_on_object", ""))[:10]},
            {
